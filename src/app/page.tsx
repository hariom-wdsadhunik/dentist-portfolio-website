...
export default function Home() {
  useEffect(() => {
    ...
    sliders.forEach(slider => {
      const range = slider.querySelector<HTMLInputElement>('.slider-range');
      const beforeWrapper = slider.querySelector<HTMLElement>('.img-before-wrapper');
    ...
    const serviceSelect = document.getElementById('modal-service-select') as HTMLSelectElement;
    ...
    if (modalCloseBtn) {
      modalCloseBtn.onclick = () => bookingModal?.classList.remove('active');
    }
    ...
    // 7. Custom Cursor & 3D Tilt Effect
  ...
  return (
    ...
    <header className="header" id="header">
        <div className="container nav-container">
            ...
            <nav className="nav-menu" id="nav-menu">
                ...
                <a href="#transformations" className="nav-link">Smile Gallery</a>
            ...
            <div className="nav-actions">
                <button className="btn btn-primary open-booking-modal">
                    <i className="fa-solid fa-calendar-check"></i> Book Visit
                </button>
                <button className="hamburger-btn" id="hamburger-btn" aria-label="Toggle Navigation">
        ...
        <div className="container hero-grid">
            <div className="hero-content">
                ...
                <div className="hero-buttons">
                    <button className="btn btn-primary btn-lg open-booking-modal">
            ...
            <div className="hero-visual">
                ...
                <div className="hero-image-wrapper">
                    <img src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=1000&q=80" alt="Dr. Sarah Jenkins Dentistry" className="hero-img" />
                </div>
        ...
        <div className="container">
            ...
            <div className="services-grid">
                ...
                <div className="service-card">
                    ...
                    <button className="service-btn open-booking-modal" data-service="Cosmetic Dentistry">Learn More & Book <i className="fa-solid fa-arrow-right"></i></button>
                </div>
                ...
                <div className="service-card featured-service">
                    ...
                    <button className="service-btn open-booking-modal" data-service="Invisalign Aligners">Book Free Consultation <i className="fa-solid fa-arrow-right"></i></button>
                </div>
                ...
                <div className="service-card">
                    ...
                    <button className="service-btn open-booking-modal" data-service="Dental Implants">Learn More & Book <i className="fa-solid fa-arrow-right"></i></button>
                </div>
                ...
                <div className="service-card">
                    ...
                    <button className="service-btn open-booking-modal" data-service="Teeth Whitening">Book Whitening <i className="fa-solid fa-arrow-right"></i></button>
                </div>
                ...
                <div className="service-card">
                    ...
                    <button className="service-btn open-booking-modal" data-service="General Checkup">Schedule Cleaning <i className="fa-solid fa-arrow-right"></i></button>
                </div>
                ...
                <div className="service-card">
                    ...
                    <button className="service-btn open-booking-modal" data-service="Emergency Dentistry">Emergency Call <i className="fa-solid fa-arrow-right"></i></button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="container about-grid">
            <div className="about-image-column">
                <div className="doctor-image-wrapper">
                    <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=800&q=80" alt="Dr. Sarah Jenkins DDS" className="doctor-img" />
            ...
            <div className="about-content">
                ...
                <div className="about-cta">
                    <button className="btn btn-primary open-booking-modal">Meet Dr. Jenkins</button>
    ...
    <section className="section gallery-section" id="transformations">
        <div className="container">
            <div className="section-header text-center">
                ...
                <p className="section-description">Drag the slider on any transformation below to see the dramatic before-and-after results achieved right here in our office.</p>
            </div>

            <div className="gallery-grid">
                {/* Case 1: Veneers */}
                <div className="transformation-card">
                    <div className="slider-container" id="slider-1">
                        ...
                        <div className="img-before-wrapper">
                        ...
                        <input type="range" min="0" max="100" value="50" className="slider-range" aria-label="Before and after slider" />
                ...
                {/* Case 2: Invisalign */}
                <div className="transformation-card">
                    <div className="slider-container" id="slider-2">
                ...
                {/* Case 3: Whitening */}
                <div className="transformation-card">
                    <div className="slider-container" id="slider-3">
            ...
            <div className="faq-accordion">
                <div className="faq-item">
                    <button className="faq-question">
                        <span>Do you accept my dental insurance?</span>
                        <i className="fa-solid fa-chevron-down"></i>
                    </button>
                    <div className="faq-answer">
                        <p>Yes! We are in-network with most major dental PPO plans including Delta Dental, Cigna, MetLife, Aetna, Guardian, and Humana. Our team files claims directly on your behalf to maximize your annual benefits.</p>
                    </div>
                </div>
                ...
                <div className="faq-item">
                    ...
                    <div className="faq-answer">
                        <p>We offer our Apex Smile Savings Plan for uninsured patients, which includes 2 cleanings, annual X-rays, and 15-20% off all dental procedures for a low annual fee. We also partner with CareCredit for 0% APR financing options.</p>
                    </div>
                </div>

                <div className="faq-item">
                    <button className="faq-question">
                        <span>How quickly can I be seen for a dental emergency?</span>
                        <i className="fa-solid fa-chevron-down"></i>
                    </button>
                    <div className="faq-answer">
                        <p>We reserve dedicated daily slots specifically for emergency patients. If you are experiencing severe pain, bleeding, or trauma, call us immediately at (512) 555-0199 for same-day priority appointment placement.</p>
                    </div>
                </div>

                <div className="faq-item">
                    <button className="faq-question">
                        <span>Is Invisalign treatment as effective as traditional braces?</span>
                        <i className="fa-solid fa-chevron-down"></i>
                    </button>
                    <div className="faq-answer">
                        <p>Absolutely. Modern 3D digital planning allows Invisalign to treat over 90% of orthodontic cases including crowding, gaps, overbites, and crossbites—often 30% faster than traditional wire braces.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section className="section contact-section" id="contact">
        <div className="container contact-grid">
            ...
            <div className="contact-card-form">
                ...
                <form id="contact-quick-form" className="quick-form">
                    ...
                    <div className="form-group">
                        <select className="form-input" required>
                            <option value="" disabled defaultValue="">Select Service Needed</option>
    ...
    <footer className="footer">
        <div className="container footer-content">
            ...
            <div className="footer-newsletter">
                ...
                <form className="newsletter-form" onsubmit="event.preventDefault(); alert('Thank you for subscribing!');">
    ...
    <div className="modal-overlay" id="booking-modal">
        <div className="modal-card">
            ...
            <form id="modal-booking-form" className="modal-form">
                <div className="form-group">
                    <label>Selected Service</label>
                    <select id="modal-service-select" className="form-input" required>
