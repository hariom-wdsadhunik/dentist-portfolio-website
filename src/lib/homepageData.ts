...
export const TRUST_METRICS: MetricItem[] = [
  ...
  },
  {
    ...
    description: "Led by Dr. Elena Rostova, BDS, MDS",
  },
  {
    id: "technology",
    value: "3D Scanning",
...
export const CORE_SERVICES: ServiceItem[] = [
  {
    ...
    feeNotice: "From ₹2,500 • Insurance documentation provided",
  ...
  },
  {
    ...
    feeNotice: "Flexible monthly installment options",
...
export const FIRST_VISIT_STEPS: VisitStepItem[] = [
  {
    ...
    description: "Arrive at our Bandra West Linking Road studio. Enjoy a beverage and relax in a quiet, non-clinical lounge.",
...
export const DEMO_TESTIMONIALS: TestimonialItem[] = [
  ...
  {
    id: "3",
    quote: "Clear aligners with Dr. Rostova were so easy. Upfront pricing with no surprise bills, convenient morning appointments before office, and an incredible result.",
    author: "Vikram K.",
