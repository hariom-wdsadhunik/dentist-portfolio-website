...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    credentials: "DDS, UT Health Science Center | Fellow, Academy of General Dentistry",
    experienceYears: "15+ Years Experience",
    bio: "Dr. Rostova founded Aura Dental Studio to bridge the gap between high-end restorative dentistry and warm, anxiety-reducing patient care. She earned her Fellowship with the AGD—a distinction held by less than 6% of general dentists.",
  ...
  },
  {
    ...
    credentials: "DDS, Baylor College of Dentistry | Member, AACD",
  ...
  },
  {
    ...
    credentials: "BSDH, Texas Woman's University",
    experienceYears: "11 Years Experience",
    bio: "Sarah brings a gentle, meticulous touch to every preventative hygiene appointment. She specializes in ultrasonic hygiene care and personalized periodontal health education.",
