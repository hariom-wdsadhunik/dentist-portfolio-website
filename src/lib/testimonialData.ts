...
export const TESTIMONIALS_DATA: TestimonialItem[] = [
  {
    ...
    context: "Completed 10-month clear aligner therapy while managing a busy corporate schedule in Bandra West, Mumbai.",
  ...
  },
  {
    ...
    category: "General",
    rating: 5,
    quote: "Woke up with an excruciating toothache on a Thursday. They answered the triage line immediately, saw me by 10 AM, and relieved the pain in under 45 minutes with total fee transparency.",
