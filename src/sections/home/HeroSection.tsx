...
export const HeroSection: React.FC = () => {
  return (
    <Section bg="canvas" className="pt-8 pb-12 sm:pt-12 sm:pb-16 md:pt-20 md:pb-24 border-b border-[#E7E2D8]">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          {/* Left Column: Text & Conversion Content */}
          <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-left">
            {/* Eyebrow Tag */}
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#F4F0E8] border border-[#E7E2D8] text-[11px] sm:text-xs font-bold text-[#0D3B36] uppercase tracking-wider">
              <SparklesIcon className="w-3.5 h-3.5 text-[#D4A373]" />
              <span>Bandra West, Mumbai Dental Studio</span>
            </div>

            {/* Main Editorial Headline */}
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#1C1917] leading-[1.15]">
              Modern, gentle dentistry designed around your comfort, schedule, and confidence.
            </h1>

            {/* Supporting Paragraph */}
            <p className="font-sans text-sm sm:text-base md:text-lg text-[#44403C] leading-relaxed max-w-2xl">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full">
              <Button href="/book" variant="primary" size="lg" className="w-full sm:w-auto justify-center shadow-md">
            ...
            <div className="pt-4 flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 sm:gap-x-6 text-xs text-[#78716C] border-t border-[#F0ECE1]">
              <span className="flex items-center space-x-1.5">
                <ShieldCheckIcon className="w-4 h-4 text-[#0D3B36] shrink-0" />
          ...
          <div className="lg:col-span-5 w-full">
            <div className="relative rounded-2xl overflow-hidden bg-[#F4F0E8] border-2 border-[#E7E2D8] p-2.5 sm:p-3 shadow-xl">
