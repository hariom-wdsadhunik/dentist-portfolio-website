      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#F4F0E8] border border-[#E7E2D8] text-xs font-bold text-[#0D3B36] uppercase tracking-wider">
            <span>Portfolio Demo Feedback</span>
          </div>
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#1C1917] tracking-tight">
            Loved by Austin Patients
          </h2>
          <p className="font-sans text-base text-[#44403C] leading-relaxed">
            Read what community members experience when visiting Aura Dental Studio for routine and cosmetic care.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {DEMO_TESTIMONIALS.map((item) => (
            <div
              key={item.id}
              className="bg-[#FAF8F3] rounded-xl border border-[#E7E2D8] p-8 flex flex-col justify-between space-y-6 shadow-sm hover:shadow-md transition-shadow"
            >
